...
class DatabaseOpenHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    suspend fun insertQuestions(db: SQLiteDatabase) {
        insertNewQuestion(db, InsertQuestion(
            ...
            textSe = "I vilken utsträckning ser du barnet som ett problem?",
            rNeglect = 0.41f,
            rPca = 0.3f,
            weightYesNeglect = 1f,
        ...
        insertNewQuestion(db, InsertQuestion(
            ...
            textSe = "Var graviditeten oplanerad?",
            rNeglect = null,
            rPca = 0.28f,
        ...
        insertNewQuestion(db, InsertQuestion(
            ...
            textSe = "Fungerar samarbetet mellan dig och barnet bra?",
            rNeglect = -0.48f,
            rPca = -0.27f,
            weightYesNeglect = 1f,
            weightMiddleNeglect = 0.5f,
        ...
        insertNewQuestion(db, InsertQuestion(
            ...
            textSe = "Använder du fysisk bestraffning i uppfostran?",
            rNeglect = null,
            rPca = 0.26f,
            weightYesNeglect = null,
            weightMiddleNeglect = null,
        ...
        insertNewQuestion(db, InsertQuestion(
            ...
            textSe = "Är du stressad över ditt föräldraskap?",
            rNeglect = 0.14f,
            rPca = 0.07f,
            weightYesNeglect = 1f,
            weightMiddleNeglect = 0.5f,
        ...
        insertNewQuestion(db, InsertQuestion(
            ...
            textSe = "Har du ett hett temperament?",
            rNeglect = 0.35f,
            rPca = 0.34f,
            weightYesNeglect = 1f,
            weightMiddleNeglect = 0.5f,
        ...
        insertNewQuestion(db, InsertQuestion(
            ...
            textSe = "Har du en psykisk sjukdom eller psykiatrisk diagnos?",
            rNeglect = null,
            rPca = 0.29f,
            weightYesNeglect = null,
            weightMiddleNeglect = null,
        ...
        insertNewQuestion(db, InsertQuestion(
            ...
            textSe = "Har du en dålig relation till dina föräldrar?",
            rNeglect = 0.19f,
            rPca = 0.22f,
            weightYesNeglect = 1f,
            weightMiddleNeglect = 0.5f,
        ...
        insertNewQuestion(db, InsertQuestion(
            ...
            textSe = "Har du som barn blivit utsatt för vanvård?",
            rNeglect = 0.15f,
            rPca = 0.21f,
            weightYesNeglect = 1f,
            weightMiddleNeglect = 0.5f,
        ...
        insertNewQuestion(db, InsertQuestion(
            ...
            textSe = "Har du blivit straffad för något brott de senaste tre åren?",
            rNeglect = null,
            rPca = 0.21f,
            weightYesNeglect = null,
            weightMiddleNeglect = null,
        ...
        insertNewQuestion(db, InsertQuestion(
            ...
            textSe = "Är du i allmänhet stressad i livet?",
            rNeglect = 0.38f,
            rPca = 0.19f,
            weightYesNeglect = 1f,
            weightMiddleNeglect = 0.5f,
        ...
        insertNewQuestion(db, InsertQuestion(
            ...
            textSe = "Har du ett socialt stöd i ditt föräldraskap?",
            rNeglect = -0.16f,
            rPca = -0.18f,
            weightYesNeglect = 1f,
            weightMiddleNeglect = 0.5f,
        ...
        insertNewQuestion(db, InsertQuestion(
            ...
            textSe = "Har någon partner, vän eller kollega kritiserat dig för att du dricker för mycket alkohol de senaste tre åren?",
            rNeglect = null,
            rPca = 0.17f,
            weightYesNeglect = null,
            weightMiddleNeglect = null,
        ...
        insertNewQuestion(db, InsertQuestion(
            ...
            textSe = "Anser du att du har en god problemlösningsförmåga med barnet?",
            rNeglect = null,
            rPca = -0.14f,
            weightYesNeglect = null,
            weightMiddleNeglect = null,
        ...
        insertNewQuestion(db, InsertQuestion(
            ...
            textSe = "Är du ensam i ditt föräldraskap?",
            rNeglect = 0.08f,
            rPca = 0.12f,
            weightYesNeglect = 1f,
            weightMiddleNeglect = 0.5f,
        ...
        insertNewQuestion(db, InsertQuestion(
            ...
            textSe = "Hur gammal är du? [Om föräldern är yngre än 18, så Ja; Om föräldern är mellan 18 och 22, så Oklart, annars Nej]",
            rNeglect = -0.12f,
            rPca = -0.1f,
            weightYesNeglect = 1f,
            weightMiddleNeglect = 0.5f,
        ...
        insertNewQuestion(db, InsertQuestion(
            ...
            textSe = "Har någon partner, vän eller kollega kritiserat dig för att du brukar för mycket droger de senaste tre åren?",
            rNeglect = null,
            rPca = 0.08f,
            weightYesNeglect = null,
            weightMiddleNeglect = null,
        ...
        insertNewQuestion(db, InsertQuestion(
            ...
            textSe = "Har barnet hög social förmåga?",
            rNeglect = -0.3f,
            rPca = -0.26f,
            weightYesNeglect = 1f,
            weightMiddleNeglect = 0.5f,
        ...
        insertNewQuestion(db, InsertQuestion(
            ...
            textSe = "Har barnet ett utåtagerande beteende?",
            rNeglect = 0.22f,
            rPca = 0.23f,
            weightYesNeglect = 1f,
            weightMiddleNeglect = 0.5f,
        ...
        insertNewQuestion(db, InsertQuestion(
            ...
            textSe = "Har barnet ett internaliserande beteende?",
            rNeglect = 0.11f,
            rPca = 0.15f,
            weightYesNeglect = 1f,
            weightMiddleNeglect = 0.5f,
        ...
        insertNewQuestion(db, InsertQuestion(
            ...
            textSe = "I hemmet där du nu bor i, uppstår det ofta konflikter mellan de vuxna?",
            rNeglect = null,
            rPca = 0.39f,
            weightYesNeglect = null,
            weightMiddleNeglect = null,
        ...
        insertNewQuestion(db, InsertQuestion(
            ...
            textSe = "I hemmet där du nu bor i, har ni god sammanhållning?",
            rNeglect = null,
            rPca = -0.32f,
            weightYesNeglect = null,
            weightMiddleNeglect = null,
        ...
        insertNewQuestion(db, InsertQuestion(
            ...
            textSe = "I hemmet där du nu bor i, har det förekommit fysiskt partnervåld de senaste tre åren?",
            rNeglect = null,
            rPca = 0.22f,
            weightYesNeglect = null,
            weightMiddleNeglect = null,
        ...
        insertNewQuestion(db, InsertQuestion(
            ...
            textSe = "Är du nöjd med relationen till din nuvarande partner?",
            rNeglect = null,
            rPca = -0.16f,
            weightYesNeglect = null,
            weightMiddleNeglect = null,
        ...
        insertNewQuestion(db, InsertQuestion(
            ...
            textSe = "Finns det tre eller flera barn i den nuvarande familjen?",
            rNeglect = 0.26f,
            rPca = 0.15f,
            weightYesNeglect = 1f,
            weightMiddleNeglect = 0.5f,
        ...
        insertNewQuestion(db, InsertQuestion(
            ...
            textSe = "Tillhör familjen medel- eller överklass?",
            rNeglect = -0.19f,
            rPca = -0.14f,
            weightYesNeglect = 1f,
            weightMiddleNeglect = 0.5f,
